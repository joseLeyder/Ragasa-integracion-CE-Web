...
export const authConfig: AuthConfig = {
    ...
    //loginUrl:'https://oauth.ragasaapps.io/auth/realms/ragasa/protocol/openid-connect/auth',
    //postLogoutRedirectUri:'https://oauth.ragasaapps.io/auth/realms/ragasa/protocol/openid-connect/auth'//environment.keycloak.redirectUri
};
